            ...
            <div className="lg:p-3 w-3/5">
                <div className="relative w-full">
                    ...
                    <input
                        ...
                        type="search" className="w-full focus:outline-0 p-4 pl-10 text-sm text-gray-900 placeholder-gray-400" placeholder="Enter Search Word Here..." />
                </div>
            </div>
