...
export default function Searchbar() {
    return (
        <div className="flex flex-wrap border lg:w-max border-primary-blue my-10 lg:my-20 p-3 w-11/12 mx-auto">
            <div className="lg:p-3 flex flex-wrap">
            ...
            <div className="bg-primary-blue flex items-center justify-center p-3 rounded-md w-full md:w-[auto]">
